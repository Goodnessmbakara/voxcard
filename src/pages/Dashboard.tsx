            ...
            {isConnected ? (
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Please connect your wallet to view your dashboard details.
                  </CardDescription>
                </CardHeader>
                <CardContent className="flex flex-col items-center py-6">
                  <div className="w-24 h-24 rounded-full bg-ajo-light/30 flex items-center justify-center mb-4">
                  ...
                  <p className="text-center text-gray-500 mb-6 max-w-md">
                    Connect your Cardano wallet to manage your savings plans, view your profile, and track your progress.
                  </p>
                </CardContent>
              </Card>
            )}
