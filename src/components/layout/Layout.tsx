...
const Layout = ({ children }: LayoutProps) => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <footer className="bg-vox-secondary text-white py-8">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-xl font-heading font-bold mb-4">VoxCard</h3>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="/plans" className="text-gray-300 hover:text-white transition-colors">Savings Plans</a></li>
          ...
          <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} VoxCard. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
